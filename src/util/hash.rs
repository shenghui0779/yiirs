...
mod tests {
    ...
    fn hash() {
        ...
        assert_eq!(
            hash::Hash(Algo::SHA512_224).from_str("shenghui"),
            "25ecca889865b41d2386b08d71e84bd4bb6dc9bfb4bda5127462ad90"
        );
        assert_eq!(
            hash::Hash(Algo::SHA512_256).from_str("shenghui"),
    ...
    fn hmac() {
        assert_eq!(
            hash::HMAC(Algo::MD5, "IIInsomnia").from_str("shenghui"),
            "cac9160ed60eb1bcca32c7460b5ca238"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA1, "IIInsomnia").from_str("shenghui"),
            "750583660d10fbadf8004f462aa7ef1d9f18cd91"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA224, "IIInsomnia").from_str("shenghui"),
            "c2b5456bf70ab7be63de54c055a66554d0ee558f1c6985a5325f2b0a"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA256, "IIInsomnia").from_str("shenghui"),
            "6ea90a066be004ca5ac384d79605d8a2403cc8a9b14ffc988822bf85be12b038"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA384, "IIInsomnia").from_str("shenghui"),
            "04faa29cd8da1e4d18d9890006242a90dfcb127e5914ceb18226857bdb04e106af54473afd6a061c9f6f16c70990d73c"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA512, "IIInsomnia").from_str("shenghui"),
        ...
        assert_eq!(
            hash::HMAC(Algo::SHA512_224, "IIInsomnia").from_str("shenghui"),
            "94732693878898c638f449a4c3c2bc6d0ed73d43d2c1c2233aeedfa2"
        );
        assert_eq!(
            hash::HMAC(Algo::SHA512_256, "IIInsomnia").from_str("shenghui"),
