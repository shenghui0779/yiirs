...
#[allow(dead_code)]
pub struct HMAC<'a>(pub Box<dyn DynDigest>, pub &'a str);
...
mod tests {
    ...
    fn digest() {
        ...
        assert_eq!(hash::<Sha384>(b"shenghui"), "1ad756ef7fbc0912b56d2609a646a2887ce34f70cbb0144a86a2f394a121dee88d09d0b47e0b99f039f36e7dba06e90d");
        assert_eq!(hash::<Sha512>(b"shenghui"), "42071eb6241a2a19c01c1cb7cad9aa5730c1d15de8b54ff4f333e7c9e5854640084f20a1406bf362c22131725c432b387832a9431859eb031b914890ddd01671");
        assert_eq!(
